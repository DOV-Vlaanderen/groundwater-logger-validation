...
`gwloggeR` package is not available on CRAN, only on GitHub. The easiest way to install it is with `devtools` package and referring to the git repository holding the package code:
