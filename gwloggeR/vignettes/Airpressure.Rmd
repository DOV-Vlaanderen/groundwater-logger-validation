...
This is an advanced guide. It explains how `detect_outliers()` works for air pressure. Make sure you have first read the getting started material.

## Outlier detection

Outliers are single measurements that are considered very unlikely to occur. The `detect_outliers()` function takes in a vector of datapoints and returns a boolean vector of outlier indicators:
