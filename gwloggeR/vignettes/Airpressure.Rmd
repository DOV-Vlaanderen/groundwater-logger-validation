...
```{r}
x <- c(1070, 985, 1071:1077, 1100)
ts <- seq(as.POSIXct('2010-01-01'), by = '5 min', length.out = 10L)
detect_outliers(x, timestamps = ts, apriori = apriori("hydrostatic pressure", "cmH2O"), plot = TRUE)
```
