...
Here you find the basic building-blocks of the package. Before continuing, make sure you have correctly [installed](https://dov-vlaanderen.github.io/groundwater-logger-validation/gwloggeR/docs/index.html#installation) the last stable version of `gwloggeR`.

## Detect functions

At its core `gwloggeR` consists of several [`detect_`](https://dov-vlaanderen.github.io/groundwater-logger-validation/gwloggeR/docs/reference/index.html#section-detection-functions) functions which take as input a vector of observations, and return a boolean vector of the same length specifying TRUE for each positive detection, and FALSE otherwise.
...
Now if all this was very obvious to you, you can give `gwlogger` a try on the real data. If you still wonder how all this works, you can read more about the algorithm in the [Hydrostatic pressure vignette](https://dov-vlaanderen.github.io/groundwater-logger-validation/gwloggeR/docs/articles/Hydropressure.html).
