# Analysis 23, 26, 28 and 32 together
...
local({
  ...
  printer(logger.names[1:100],
          pdf.filename = './drifts/analysis_33/comparison_part1.pdf')
  printer(logger.names[101:length(logger.names)],
          pdf.filename = './drifts/analysis_33/comparison_part2.pdf')
